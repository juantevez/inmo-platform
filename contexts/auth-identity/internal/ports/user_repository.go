...
type UserRepository interface {
	// Save inserta un usuario nuevo junto con su proveedor inicial (EMAIL o SSO) en una transacción (UC-01/04/05)
	Save(ctx context.Context, user *domain.User, provider *domain.IdentityProvider) error
